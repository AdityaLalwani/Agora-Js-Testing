...
function initClientAndJoinChannel(agoraAppId="0e1d5d6634aa4aa7806b2334b14fde35", token, channelName) {
  // init Agora SDK
  client.init(agoraAppId, function () {
    console.log("AgoraRTC client initialized");
    joinChannel(channelName,  token); // join channel upon successfull init
  }, function (err) {
